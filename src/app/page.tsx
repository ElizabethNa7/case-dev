...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className='pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 x1:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>          {/*reusable React component wrapper for consistent padding/width etc*/}
          <div className='col-span-2 px-6 lg:px-0 lg:pg-4'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              <div className='absolute w-28 left-0 -top-10 hidden lg:block'>
                <img src="/gojo-chibi.png" className='w-full'></img>
              </div>
        ...
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
              ...
              <img src='/gojo-chibi.png' className='w-32 order-0 lg:order-2'/>
          </div>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                ...
                <div className='flex flex-col'>
                  <p className='font-semibold'>Haruka</p>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                ...
                />
                <div className='flex flex-col'>
                  <p className='font-semibold'>That guy from Wisteria</p>
                  <div className='flex gap-1.5 items-center text-zinc-600'>
                    <Check className='h-4 w-4 stroke-[3px] text-green-600'/>
                    <p className='text-sm'>Verified Purchase</p>
                  </div>
